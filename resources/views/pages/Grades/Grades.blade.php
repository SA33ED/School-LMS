            ...
            <tbody>
                ...
                @foreach ($grades as $grade)
                    ...
                    <tr>
                        ...
                        <td>{{$grade->notes}}</td>
                        <td>
                            <button type="button" class="btn btn-info btn-sm" data-toggle="model" data-target="#edit{{$grade->id}}"
                                title="{{trans('grades_trans.edit')}}"><i class="fa fa-edit"></i>
                            </button>
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="model" data-target="#delete{{$grade->id}}"
